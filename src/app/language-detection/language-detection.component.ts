...
import { LanguageAvailableComponent } from './components/language-available.component';
import { LanguageDetectionResultComponent } from './components/language-detection-result.component';

@Component({
    selector: 'app-language-detection',
    imports: [FormsModule, LanguageAvailableComponent, LanguageDetectionResultComponent],
    standalone: true,
    template: `
